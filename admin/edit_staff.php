...
<?php  $query= mysqli_query($conn,"SELECT * FROM staff WHERE staff_id='$id'");
    $row=mysqli_fetch_assoc($query); ?>
                            <form class="user" method="POST">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control form-control-user" id="CNIC_No" name="staff_cnic"  placeholder="XXXXXXXXXXXXX" value="<?=$row['staff_cnic']?>" pattern="[0-9]{5}[0-9]{8}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-12">
