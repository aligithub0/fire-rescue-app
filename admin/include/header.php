...
<head>
    ...
    <title>ADMIN</title>
    <link rel="shortcut icon" type="image/x-icon" href="../upload/admin.png" />
    ...
    <link href="../assets/dist/admin-modern.css?v=6" rel="stylesheet" />
</head>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="station.php">View All Stations</a>
                        <a class="collapse-item" href="registerStation.php">Create New Stations</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider" />
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="manage_reports.php">Manage Reports</a>
                    </div>
            </li>
            <!-- Divider -->
            <hr class="sidebar-divider d-none d-md-block" />
            ...
            <li class="nav-item">
                ...
                <div id="collapseEmploye" class="collapse" aria-labelledby="headingEmploye"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Staff</h6>
                        <a class="collapse-item" href="view_staff.php">All Members</a>
