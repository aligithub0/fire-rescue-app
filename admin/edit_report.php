...
if (isset($_GET['edit_id'])) {
    $edit_id=$_GET['edit_id'];
        ...
        echo "<script>window.location='manage_report.php'</script>";
}
...
if (!empty($_POST) AND isset($_POST['submit'])) {
  ...
  $complete_detail=$_POST['complete_detail'];
        ...
        $query=mysqli_query($conn,"UPDATE reports SET report_id='$report_id',case_name='$case_name',deaths='$deaths',city='$city',location_name='$location_name',report_date='$report_date',complete_detail='$complete_detail' WHERE report_id=$report_id");
        if ($query) {
        echo "<script>window.location='report_detail.php?report_id=$edit_id'</script>";
    }else{
        $msg="Error";
        $status= 'danger';
        }
...
<?php  $query= mysqli_query($conn,"SELECT * FROM reports WHERE report_id='$edit_id'");
